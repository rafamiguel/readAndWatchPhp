...
if(isset($_GET["idTema"]) && isset($_GET["tipo"]) && isset($_GET["descripcion"])&& isset($_GET["ruta"]) && isset($_GET["fechaSubida"])){
    ...
    (idVidDoc,tipo,descripcion,rutaImagen,ruta,fechaSubida,visitas,idUsuario,idTema,idReportesVidDoc) values(0,'v','Nose','@drawable/miniatura','{$ruta}',{$fechaSubida},0,1,{$idTema},1) ";
    echo $sentencia;
